...
insert into t_user(id,username,password,real_name,unit,tel,email,create_time,update_time,role_id,status,remarks) 
	values(2,'teacher','123456','小红','教育部','110','34@qq.com',null,null,2,1,null);
insert into t_user(id,username,password,real_name,unit,tel,email,create_time,update_time,role_id,status,remarks) 
	values(3,'enoch','123456','丁丁','教育部','110','34@qq.com',null,null,3,1,null);
...
insert into t_menu(id,name,uri,description,pid,menu_level,create_time,update_time) 
			values(22,'用户列表','/user',null,21,2,null,null);
...
　　在校内申报阶段若无合适的指导老师，可暂不填写申报书的相关栏目，后续可由创新创业学院为其选配指导老师。','2019-01-04');
